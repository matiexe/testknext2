                 ...
                 <div className="mx-auto  relative  lg:-mt-96  container px-4 pb-2 xl:px-0 mt-14">
                    ...
                    <div className="xl:flex  items-center lg:mt-12">
                        <div className="mt-6  inset-y-4 lg:mt-0">
                            ...
                            <p className="w-10/12 lg:w-7/12 leading-8 text-white sm:text-white  md:text-white xl:text-gray-600 font-semibold mt-5 mb-12">Envianos tus consultas o programa una reunion con nosotros atravez de Calendly!</p>
                        </div>
