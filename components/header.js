                ...
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                ...
                                <Links href="">
                                    <a
                                        className="text-gray-700  hover:text-blue-400 px-3 py-4 rounded-md text-lg font-medium">Proyectos</a>
                                </Links>
                                <Links href="/services">
                                    <a
                                        className="text-gray-700 hover:text-redNaphtol px-3 py-4 rounded-md text-lg font-medium">Servicios</a>
                                </Links>
                                <Links href="#">
                                    <a
                                        className="text-gray-700 hover:text-orange-400 px-3 py-4 rounded-md text-lg font-medium">Equipo</a>
                                </Links>
                    ...
                    <div
                        ...
                        <div className="  md:flex items-center justify-end md:flex-1 lg:w-0">
                            <a href="#"
                               className=" lg:block cursor-pointer hidden ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700">
                                <button type="button" className="" onClick={() => scroll.scrollTo(3000)}>Contacto</button>
                            </a>
                            <a href="#"
                               className="block cursor-pointer lg:hidden ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700">
                            ...
                            <a href="#"
                               className="lg:block hidden ml-8  whitespace-nowrap inline-flex items-center justify-center px-2 py-2  text-base font-medium text-gray-600">
                                ESP | ENG
                            </a>
                        </div>
                    </div>
