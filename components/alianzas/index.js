               ...
               >
                <div className="h-64 z-20">
                   ...
                   <div className="p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative">
                     ...
                     <p className="text-gray-500 font-custom text-center pb-1 text-sm">Cluster impulso tecnoclogico</p>
                   </div>
                 </div>
                 <div                  
               ...
               >
                <div className="h-64 z-20">
                   ...
                   <div className="p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative">
                     ...
                     <p className="text-gray-500 font-custom text-center pb-1 text-sm">MicroSis</p>
                   </div>
                 </div>          
                 <div
               ...
               >
                <div className="h-64 z-20">
                     <img
                       src="/Asistec.png"
                       alt="Asistec"
                       className="h-42  w-full  pt-14 bg-white  object-cover overflow-hidden rounded"
               
                     />
                   </div>
                   <div className="p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative">
                     <p className="uppercase text-sm text-gray-700 font-custom text-center pb-1">Assistec</p>
                     <p className="text-gray-500 font-custom text-center pb-1 text-sm">Assistec</p>
                   </div>
                 </div>
                 <div
                   ...
                   className=" pl-2 xl:w-1/4 sm:w-5/12 sm:max-w-xs relative mb-32 lg:mb-20
                         xl:max-w-sm lg:w-1/2 w-11/12 mx-auto sm:mx-0 cursor-pointer hover:scale-105"       
               >
                <div className="bg-gray-400 h-64 z-20">
                     <img
                       src="/LOGO-CLUSTER.png"
                       alt="Cluster Tecnologico Santa Cruz"
                       className="h-42 pt-10 w-full object-cover overflow-hidden rounded"
                      
                     />
                   </div>
                   <div className="p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative">
                     <p className="uppercase text-sm text-gray-700 font-custom text-center pb-1">Cluster Tecnologico Santa Cruz</p>
                     <p className="text-gray-500 font-custom text-center pb-1 text-sm">Cluster Tecnologico Santa Cruz</p>
                   </div>
                 </div>
