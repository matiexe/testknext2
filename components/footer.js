    ...
    return (
        <footer className="border-t border-gray-200 ">
            <div className=" container flex flex-wrap items-center justify-center px-4 py-6  mx-auto  lg:justify-between">
                ...
                <div className="flex-shrink-0 w-full lg:w-auto justify-center flex items-center">
                    <Link href={"/"}>
                        <button className={"flex-1 flex"}>
                            ...
                            <img className="hidden w-14 lg:block h-16 w-auto"
                                 src="/logo.svg"
                                 alt="Workflow"/>
                            <span className="hidden lg:block justify-center text-4xl h-7 py-3 font-custom">Kaizen IT</span>
                            <span className="block lg:hidden justify-centers text-3xl h-7 py-3 font-custom">Kaizen IT</span>
                        </button>
                    </Link>
                </div>
                ...
                <div className="flex py-6  w-full lg:w-auto flex-wrap justify-center">
                    <ul className="flex items-center space-x-4">
                        <Link href="/Proyect"><a className=" hover:text-blue-400 ">Proyecto</a></Link>
                        <Link href="/services"><a className=" hover:text-red-500 ">Servicio</a></Link>
                        <Link href="/"><a className=" hover:text-orange-400" >Equipo</a></Link>
                    </ul>
                </div>
                ...
                <div className="flex items-center py-6 my-4 lg:my-0">
                    <form className="flex cursor-pointer flex-wrap items-center justify-center">
                        <button type="button" className=" px-6 py-2 text-white bg-red-500  border-0 rounded focus:outline-none hover:bg-red-700" onClick={() => scroll.scrollTo(6000)}>Contactenos</button>
                    </form>
                </div>
